        ...
        <div className="w-full md:w-1/2">
          <ul className="space-y-6 text-gray-800">
            <li className="text-base md:text-lg">
              ...
              consectetur quaerat exercitationem nesciunt earum id corporis debitis.
            </li>
            <li className="text-base md:text-lg">
            ...
            <li className="text-base md:text-lg">
              Cupiditate sed non ut deserunt eveniet numquam totam, vitae aliquid
              est voluptates ea cum voluptas amet facilis!
            </li>
          </ul>
        </div>
